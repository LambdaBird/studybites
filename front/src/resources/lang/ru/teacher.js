export default {
  ...
  course_edit: {
    ...
    publish_modal_fail: {
      ...
      content:
        'Невозможно опубликовать курс так как один из уроков имеет статус "Архивирован"',
      ok: 'Ок',
    },
    message: {
  ...
  lesson_edit: {
    unsaved_modal: {
      ...
      content: `Вы внесли обновления в Урок, но не сохранили эти изменения. Вы хотите сбросить эти изменения?`,
      ok_text: 'Сбросить',
